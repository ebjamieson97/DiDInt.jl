...
**DiDInt.jl** introduces two functions: one for estimation (`didint()`, and one for plotting `didint_plot()`). The syntax for these functions can be found [here](functions.md).
